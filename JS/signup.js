...
const passcheck = (passwordinput.oninput = () => {
  let password = document.querySelector("#password").value;
  if (password.length >= 7 && (password.includes("@")|| password.length >= 8 && password.includes("$")||password.length >= 8 && password.includes("%")||password.length >= 8 && password.includes("#")||password.length >= 8 && password.includes("&"))
  ) {
